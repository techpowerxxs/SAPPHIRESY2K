define({
  ...
  ,'terminal': {
    icon: '../v1-sub/c/sys/ico32/terminal.png',
    exec: function(cfg) {
      $terminal(cfg);
    }
  }
  ...
  ,'contact': {
    exec: function(path, opt) {
      ...
      $alert({
        ...
        title: 'CONTACT US',
        img: '../v1-sub/c/sys/ico32/mail.png'
      });
    }
  }
...
/*
  ...
  ,'bytebeat': {
    exec: function(opt) {
      ...
      opt.icon = '../v1-sub/c/sys/ico32/bytebeat.png';
          ...
          action = {
            ...
            about: function() {
              $alert({
                ...
                img: '../v1-sub/c/libs/codemirror/doc/logo.png',
                onopen: $noop
              });
              //$info('<img src="../v1-sub/c/libs/codemirror/doc/logo.png">CodeMirror is a versatile text editor implemented in JavaScript for the browser.<br><a href="http://codemirror.net" target="_blank">codemirror.net</a>')
            }
          },
          menu = [
            {name: 'File', items: [
  ...
  ,"pony": {
    ...
    /*  createSelector('sound', function(item) {
      ...
      vj.open = function() {
        ...
        $window({
          title:'poney jockey',
          icon:'../v1-sub/c/sys/ico32/poney.gif',
    ...
    exec: function() {
      ...
      function m() {
        ...
        $error({
           msg: msg
          ,title: 'MANIFESTO'
          ,img: '../v1-sub/c/sys/ico32/question.png'
          ,btnCancel: 'wtf?'
          ,animationIn: ''
          ,animationOut: ''
  ...
  ,"solitude": {
    exec: function() {
      ...
      var data = {
        ...
        icon: '../v1-sub/c/sys/ico32/solitaire.gif',
        title: 'Solitude',
        width: 630,
        height: 440,
        onopen: function(el) {
  ...
  ,"potato": {
    exec: function() {
      var data = {
        ...
        ,icon: '../v1-sub/c/sys/ico32/potato.png'
        ,title: 'POTATO'
        ,width: 560
        ,height: 315
      };
  ...
  ,"anthology": {
    exec: function() {
      var data = {
        ...
        ,icon: '../v1-sub/c/sys/ico32/trophy.gif'
        ,title: 'ANTHOLOGY'
        ,width: 560
        ,height: 315
      };
  ...
  ,"live": {
    exec: function() {
      var data = {
        ...
        ,icon: '../v1-sub/c/sys/ico32/sound_on.png'
  ...
  ,"castlegafa": {
    exec: function() {
      var data = {
        ...
        ,icon: '../v1-sub/c/programs/games/castleGafa/icon.gif'
  ...
  ,"lisa": {
    exec: function() {
      $exe('layer', {
        title: 'lisa',
        url: '../v1-sub/c/files/images/gif/lisa.gif',
        onopen: function(win) {
          setTimeout(function() {
            win.style.top = 'auto';
            win.style.left = 'auto';
    ...
    exec: function() {
      function hydra() {
        $alert({
          ...
          title: 'HYDRA',
          img: '../v1-sub/c/sys/ico32/hydra.png',
    ...
    exec: function(arg, term) {
      ...
      function $docAlert(msg) {
        $alert({
          ...
          img: '../v1-sub/c/sys/ico32/doctor.gif',
          btnOk: 'Thanks !',
          msg: msg
        });
      }
  ...
  ,'marburg': {
    ...
    exec: function(arg, term) {
      ...
      imageObj.src = '../v1-sub/c/files/images/png/error-alpha.png';
      animate();
